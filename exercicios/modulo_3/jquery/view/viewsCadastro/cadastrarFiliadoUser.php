  ...
  <form method="POST" action="registrar">
	...
	<div class="row">
	  ...
	  <div class="form-group col-md-2">
  	  	<label for="empresa">Empresa  <a href="#"  id="addComboEmpresa" onclick="CadastrarEmpresa()" ><img src="<?php echo LOCAL."imagens/addCombo.png"?>"></a> </label>
...
<legend>Adicionar Novo dependente <a href="#" onclick="cadastrarDependente()" ><img src="../imagens/plus.png">
</a></legend>
  ...
  <?php  foreach ($aDependentes as $key) { ?>
        <?php if(isset($key['nomeDependente'])) {?>
             ...
             <td><a href="removerDependente/<?php echo $key['chave']?>" >
              ...
              <a  href="#" data-id="<?php echo $key['chave'];?>" onclick="editDependent(this.name)"  name="<?php echo $key['chave'];?>" >
