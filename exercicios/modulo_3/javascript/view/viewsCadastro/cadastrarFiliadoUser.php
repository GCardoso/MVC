...
<div class="btn-group-vertical" role="group" aria-label="...">
  <button title="Dados pessoais" type="button" class="btn btn-default"><img onclick="exibirElementos(main,dependente)"  ondblclick="ocultarElementos(main)" src="<?php echo LOCAL."imagens/DadosPessoais.png"?>"></button>
  <button  title="Dependentes" type="button" class="btn btn-default"><img  onclick="exibirElementos(dependente,main)"  ondblclick="ocultarElementos(dependente)"  src="<?php echo LOCAL."imagens/Dependentes.png"?>"/button>
</div>
 <div id="main" class="container-fluid" style="display:none">
  ...
  <form method="POST" action="registrar">
	  ...
	  <div class="form-group col-md-4">
        ...
        onkeypress="ObjectFiliado.mascaraCPF(cpf)" required="">
  	  </div>
	  <div class="form-group col-md-4">
	...
	<div class="row">
      ...
      <div class="form-group col-md-2">
        ...
        <input type="text" class="form-control" id="fixo" placeholder="fixo" name="fixo" onkeypress="ObjectFiliado.telefone_fixo(fixo)" required="" maxlength="9" minlength="9"/>
      </div>
       <div class="form-group col-md-1">
        <label for="Movel">Telefone Movel</label>
        <input type="text" class="form-control" id="Movel" placeholder="Movel" name="Movel" onkeypress="ObjectFiliado.telefone(Movel)"  maxlength="14" minlength="14" required="">
      </div>
	</div>	
	<hr/>	
	<div class="row">
...
<div class="col-xs-9" id='dependente' style="display:none">
<legend><h2>Lista de Dependentes</h2></legend>
<legend>Adicionar Novo dependente <a data-toggle="modal" data-target="#myModal"><img src="../imagens/plus.png">
</a></legend>
