...
<table class="table table-bordered">
   ...
   <?php if(!empty($aValor)){ ?>
      ...
      <tr>
           ...
           <td> <a href="#" id="removelink" onclick="confirm(this.name)"  onload="deletarItem('cargo/deletar/',this.name)" name="<?php echo $key['id_cargo'] ?>">
...
<!-- <a href="deletar/<?php echo $key['id_cargo'] ?>" id="removelink" > -->